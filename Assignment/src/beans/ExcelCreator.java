...
public class ExcelCreator {
    ...
    public HSSFWorkbook createWorkbook(List<Admin> userList) throws Exception {

        HSSFWorkbook wb = new HSSFWorkbook();
        HSSFSheet sheet = wb.createSheet("Admin Data");
...
int row=1;
        for (int index = 0; index < userList.size(); index++) {
            ...
            Admin userData = (Admin) userList.get(index);
            ...
            cell = headerrow.createCell(5);
            HSSFRichTextString userid = new HSSFRichTextString(userData.getUserid());
