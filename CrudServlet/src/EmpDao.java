...
public class EmpDao extends DbConnection {
	...
	/*public static Connection getConnection(){
		...
		try{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost/reg","root","889325Ca");
	...
	public static int save(Emp e){
		System.out.println("Hello world! save is hear000");
		int status=0;
		try{
			...
			System.out.println("Hello world! save is hear");
